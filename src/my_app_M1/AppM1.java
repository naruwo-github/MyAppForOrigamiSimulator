...
public class AppM1 extends JFrame implements MouseListener, ActionListener, MouseMotionListener, ChangeListener{
	...
	List<List<Integer>> straightx = new ArrayList<List<Integer>>(); //確定後x座標
  	...
  	List<Color> straightColorList = new ArrayList<Color>(); //直線の際の色を記憶するリスト
  //--------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------
  	...
  	int bnum = 25; //rulingスタート地点の分割数
  	List<Double> heikatsu = new ArrayList<Double>(); //平滑化の値を格納するリスト
  	//Ruling用のスライダー
  	JSlider runum = new JSlider(5,45,25);
  	//
  	JButton nums = new JButton(String.valueOf(bnum));
  	//
  	//
  	//これがポイント
  	//折り線の情報
  	List<Boolean> creaseInfo = new ArrayList<Boolean>();
  	//Rulingの情報(色とか、折り角度の強さとか)
  	List<List<Color>> ruleColorInfo = new ArrayList<List<Color>>();
  	//描画よう
  	List<List<Integer>> rulex = new ArrayList<List<Integer>>();
  	List<List<Integer>> ruley = new ArrayList<List<Integer>>();
  	//
  //追加前の制御てんを変更するやつ
    int selectnum = 0; //1~4
  ...
  //追加後の直前の4つの制御点を変更するやつ
    ...
    //四角形の色
    List<Color> squareColorList = new ArrayList<Color>();
  	//--------------------------------------------------------------------------
	...
	void init() {
		setBounds(50,50,1100,1000);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		Container contentPane = getContentPane();
		p = new JPanel();
		p.setLayout(null);

		JButton rulingNum = new JButton("Ruling Num");
		rulingNum.setBounds(0,600,170,40);
		p.add(rulingNum);
		//nums = new JButton(String.valueOf(bnum+1));
		nums.setBounds(170,600,30,40);
		p.add(nums);
		runum.setBounds(0,630,200,50);
		runum.addChangeListener(this);
		p.add(runum);
		...
		Straight.setBounds(0,0,100,100);
		//Straight.setIcon(new ImageIcon("/Users/naruchan/desktop/ドローツールの元/アプリに使う6060/直線ツールの元.png"));
		Straight.setIcon(new ImageIcon("./forDrawApp/myIcons6060/straightlineTool.png"));
		Straight.setActionCommand("Straight");
		Straight.addActionListener(this);
		p.add(Straight);

		//Rulingツール
		JButton Ruling = new JButton("");
		Ruling.setBounds(0, 100, 100, 100);
		//Ruling.setIcon(new ImageIcon("/Users/naruchan/desktop/ドローツールの元/アプリに使う6060/rulingの元.png"));
		Ruling.setIcon(new ImageIcon("./forDrawApp/myIcons6060/rulingTool.png"));
		Ruling.setActionCommand("Ruling");
		Ruling.addActionListener(this);
		p.add(Ruling);

		//四角形ツール(トレース)
		JButton Square = new JButton("");
		Square.setBounds(0, 200, 100, 100);
		//Square.setIcon(new ImageIcon("/Users/naruchan/desktop/ドローツールの元/アプリに使う6060/四角形ツールの元.png"));
		Square.setIcon(new ImageIcon("./forDrawApp/myIcons6060/squareTool.png"));
		Square.setActionCommand("Square");
		Square.addActionListener(this);
		p.add(Square);

		//rulingの色を変更
		JButton RuleCol = new JButton("Edit Color");
		RuleCol.setBounds(0, 300, 100, 100);
		RuleCol.setActionCommand("RuleCol");
		RuleCol.addActionListener(this);
		p.add(RuleCol);

		JButton Add = new JButton("Add");
		Add.setBounds(0, 400, 100, 100);
		...
		Delete.setBounds(100, 400, 100, 100);
		Delete.setActionCommand("Delete");
		Delete.addActionListener(this);
		p.add(Delete);

		JButton Col = new JButton("Color");
		Col.setBounds(0, 500, 200, 100);
		...
		JMenu menu1 = new JMenu("AppM1");
		JMenu menu2 = new JMenu("File");
		JMenu menu3 = new JMenu("Edit");
		JMenu menu4 = new JMenu("Out");
		menubar.add(menu1);
		menubar.add(menu2);
		menubar.add(menu3);
		menubar.add(menu4);
		JMenuItem menuitem1 = new JMenuItem("About AppM1");
		JMenuItem menuitem2 = new JMenuItem("Prefference");
		JMenuItem menuitem3 = new JMenuItem("New");
		JMenuItem menuitem4 = new JMenuItem("Open");
		JMenuItem menuitem5 = new JMenuItem("Save");
		JMenuItem menuitem6 = new JMenuItem("Save as");
		JMenuItem menuitem7 = new JMenuItem("Undo");
		JMenuItem menuitem8 = new JMenuItem("Redo");
		JMenuItem menuitem9 = new JMenuItem("Svg");
		menuitem1.setActionCommand("about");
		menuitem2.setActionCommand("preff");
		menuitem3.setActionCommand("new");
		menuitem4.setActionCommand("open");
		menuitem5.setActionCommand("save");
		menuitem6.setActionCommand("saveas");
		menuitem7.setActionCommand("undo");
		menuitem8.setActionCommand("redo");
		menuitem9.setActionCommand("svg");
		...
		label = new JLabel(new ImageIcon("./forDrawApp/exDevelopmentOrigami/simpleCurve.png"));
		//label = new JLabel(new ImageIcon("/Users/naruchan/desktop/折り紙シミュレータ/単純な曲線を二本並べたやつ/曲線2本.png"));
		label.setBounds(250, 75, 800, 800);
		p.add(label);
	...
	Color st = new Color(255, 0, 0, 150);
	Color ru = new Color(255, 255, 0, 150);
	Color sq = new Color(0, 0, 255, 150);
	Color ed = new Color(0, 255, 0, 150);

	public void paint(Graphics g) {
		super.paint(g);
		MyPaint.drawInfoApp(g);
		if(state != 3) {
			//------------------------------------------
			//初期化が必要なリストたち
	    	...
	    	//rulingの色を指定するやーつ
	    	ruleColorInfo = new ArrayList<List<Color>>();
	    	rulex = new ArrayList<List<Integer>>();
	    	ruley = new ArrayList<List<Integer>>();
	    	//-------------------------------------------
		}
		//それぞれのツールの色
		//直線ツール
		g.setColor(st);
		g.fillRect(103, 48, 93, 93);
		//Rulingツール
		g.setColor(ru);
		g.fillRect(103, 48+100, 93, 93);
		//四角形ツール
		g.setColor(sq);
		g.fillRect(103, 48+100+100, 93, 93);
		//editツール
		g.setColor(ed);
		g.fillRect(103, 48+100+100+100, 93, 93);
		//色の縁取り
		g.setColor(Color.BLACK);
		g.drawRect(103, 48, 93, 93);
		g.drawRect(103, 48+100, 93, 93);
		g.drawRect(103, 48+100+100, 93, 93);
		g.drawRect(103, 48+100+100+100, 93, 93);
		//現在のツールを示す
		if(state == 0) {
			//直線ツール
			MyPaint.drawTriangle(g, 103+100, 48+50);
		}else if(state == 1) {
			//Rulingツール
			MyPaint.drawTriangle(g, 103+100, 48+50+100);
		}else if(state == 2) {
			//四角形ツール
			MyPaint.drawTriangle(g, 103+100, 48+50+100+100);
		}else if(state == 3) {
			MyPaint.drawTriangle(g, 103+100, 48+50+100+100+100);
		}
		...
		if(straightx.size() > 0) {
			for(int i = 0; i < straightx.size(); i++) {
				g.setColor(straightColorList.get(i));
		...
		if(state != 3) {
	    	...
	    	if(cpx.size()%4 == 0 && cpx.size() != 0) {
	    		...
	    		//制御点もドラッグのために書き出しておこうかな
	    		for(int i = 0; i < cpx.size(); i++) {
	    			g.setColor(Color.RED);
	    			g.drawOval(cpx.get(i),cpy.get(i),1,1);
	    		}
	    	}
	    	//輪郭線を表示させる部分
	    	if(cpx.size() >= 12 && (cpx.size()-4) % 8 == 0) {
	        	...
	        	//rulingに関する記述をする
	        	//rulingを計算する部分(輪郭線も考慮)
	    		//rulingツールの時
	    		if(cpx.size() >= 12 && cpx.size() != 0) {
		    		g.setColor(ru);
		    		MyRuling.drawRuling(rulex, ruley, ru, ruleColorInfo, g, cpx, cpy, coorinx, cooriny, heikatsu, rux, ruy, orix, oriy);
			   	}
	    	}
		}

		if(cpx.size() >= 20 && (cpx.size()-20)%8 == 0) {
			//折り線の描画
			for(int i = 19; i < cpx.size(); i+=8) {
				if(creaseInfo.get((i-19)/8) == true) {
					//MF
					g.setColor(Color.RED);
				}else {
					g.setColor(Color.BLUE);
				}
				MyBezier.drawBezier(g, cpx.get(i-12-3), cpy.get(i-12-3), cpx.get(i-12-2), cpy.get(i-12-2), cpx.get(i-12-1), cpy.get(i-12-1), cpx.get(i-12), cpy.get(i-12));
			}
		}
		...
		if(rulex.size() > 0) {
    		//int num = 0;
    		for(int i = 0; i < ruleColorInfo.size(); i++) {
    			System.out.println(ruleColorInfo.size()+" , "+rulex.size());
    			List<Color> tmpc = ruleColorInfo.get(i);
    			List<Integer> tmprux = rulex.get(i);
    			List<Integer> tmpruy = ruley.get(i);
    			for(int j = 0; j < tmpc.size(); j++) {
    				g.setColor(tmpc.get(j));
    				g.drawLine(tmprux.get(j*2), tmpruy.get(j*2), tmprux.get(j*2+1), tmpruy.get(j*2+1));
    				//g.drawLine(rux.get(num), ruy.get(num), rux.get(num+1), ruy.get(num+1));
    				//num+=2;
    			}
    		}
    	}
    	...
    	if(rux.size() > 0) {
    		int num = 0;
    		for(int i = 0; i < ruleColorInfo.size(); i++) {
    			System.out.println(ruleColorInfo.size());
    			List<Color> tmpc = ruleColorInfo.get(i);
    			for(int j = 0; j < tmpc.size(); j++) {
    				g.setColor(tmpc.get(j));
    				g.drawLine(rux.get(num), ruy.get(num), rux.get(num+1), ruy.get(num+1));
    	...
    	*/
    	...
    	if(sqxlist.size() > 0) {
    		for(int i = 0; i < sqxlist.size(); i++) {
    			int[] x = sqxlist.get(i);
    			int[] y = sqylist.get(i);
    			g.setColor(squareColorList.get(i));
	...
	public void stateChanged(ChangeEvent e) {
		bnum = runum.getValue();
		System.out.println("Rule Segments are "+bnum);
		heikatsu = new ArrayList<Double>();
		for(int i = 0; i < bnum; i++) {
			heikatsu.add(1.0/(bnum+1.0));
		}
		nums.setText(String.valueOf(bnum));
		repaint();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(cmd == "Straight") {
			...
			if(state == 0) {
	        	...
	        	//
	        	//制御線を自動で入力する奴
	        	if(cpx.size() > 0 && cpx.size()%8 == 0) {
	        		//2曲線で囲まれた時、3曲線めを自動で追加する
	        		int cpn = cpx.size();
	        		cpx.add((int)(cpx.get(cpn-1-3)+cpx.get(cpn-1-3-4))/2);
	        		cpy.add((int)(cpy.get(cpn-1-3)+cpy.get(cpn-1-3-4))/2);
	        		cpx.add((int)(cpx.get(cpn-1-2)+cpx.get(cpn-1-2-4))/2);
	        		cpy.add((int)(cpy.get(cpn-1-2)+cpy.get(cpn-1-2-4))/2);
	        		cpx.add((int)(cpx.get(cpn-1-1)+cpx.get(cpn-1-1-4))/2);
	        		cpy.add((int)(cpy.get(cpn-1-1)+cpy.get(cpn-1-1-4))/2);
	        		cpx.add((int)(cpx.get(cpn-1)+cpx.get(cpn-1-4))/2);
	        		cpy.add((int)(cpy.get(cpn-1)+cpy.get(cpn-1-4))/2);
	        	}
	        	//
	        	//
	        	*/
	        	...
	        	if(cpx.size() >= 20 && (cpx.size()-20)%8 == 0) {
	        		creaseInfo.add(true);
	        		System.out.println(creaseInfo.size());
	        	}
			...
			if(state == 0) {
				...
				if(straightx.size() > 0) {
					List<List<Integer>> tmpx = new ArrayList<List<Integer>>();
				  	...
				  	for(int i = 0; i < straightx.size()-1; i++) {
				  		tmpx.add(straightx.get(i));
				  		tmpy.add(straighty.get(i));
				  		tmpc.add(straightColorList.get(i));
				  	}
				  	straightx = tmpx;
				  	straighty = tmpy;
				  	straightColorList = tmpc;
				}
				repaint();
			}else if(state == 1) {
				//Rulingツール
				//折り線について記入する部分
	        	if(cpx.size() >= 20 && (cpx.size()-20)%8 == 0) {
	        		creaseInfo.remove(creaseInfo.size()-1);
	        		System.out.println(creaseInfo.size());
	        	}
				...
				if(sqxlist.size() > 0) {
					squareColorList.remove(squareColorList.size() - 1);
			...
			//色変更画面
			JColorChooser colCho = new JColorChooser();
			Color colcho = JColorChooser.showDialog(this, "Selecting Colors", Color.white);
			if(state == 0) {
				//直線ツール
				st = colcho;
			}else if(state == 1) {
			...
			//svgファイルへの出力
			System.out.println("Output for SVG...");

			MyFileManager.MyWriteOutToSvg(creaseInfo, ruleColorInfo, bnum, sqxlist, sqylist, cpx, cpy, rulex, ruley, orix, oriy);
			//if(cpx.size() >= 12 && cpx.size() != 0) {
			//	MyFileManager.MyWriteOutToSvg(bnum, sqxlist, sqylist, cpx, cpy, rux, ruy, orix, oriy);
			//}
		...
		if(state == 0) {
			...
			if(ruleColorInfo.size() > 0) {
				...
				for(int i = 0; i < ruleColorInfo.size(); i++) {
					...
					List<Integer> tmpruy = ruley.get(i);
					for(int j = 0; j < tmpc.size(); j++) {
						if(dist > MyPaint.calcDistDouble(tmprux.get(j*2+0), tmpruy.get(j*2+0), e.getX(), e.getY())) {
							index1 = i;
							index2 = j;
							dist = MyPaint.calcDistDouble(tmprux.get(j*2+0), tmpruy.get(j*2+0), e.getX(), e.getY());
						}
					}
				}
				List<Color> tmpc2 = ruleColorInfo.get(index1);
				tmpc2.set(index2, ed);
				ruleColorInfo.set(index1, tmpc2);
			}
			repaint();
		}
	}
