...
public class MyFileManager3 {
	...
	static void MyWriteOutToSvg(int hnum, List<Integer> cpx, List<Integer> cpy, List<Integer> rux, List<Integer> ruy, List<Integer> orix, List<Integer> oriy){
		...
		try {
			...
			pw.println("<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"1000px\"");
			pw.println("		height=\"1000px\" viewBox=\"0 0 1000 1000\" enable-background=\"new 0 0 1000 1000\" xml:space=\"preserve\">");
